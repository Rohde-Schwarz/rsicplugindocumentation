...
File browser is a handy feature that allows you to seamlessly copy files between you computer and your instrument, or even between two of your instruments.
...
.. image:: images/func_panel_file_browser.png
...
5. **Selected File Contenxt menu** - Example of the context menu for a single file. The context menu differs for multiple files selection, or a folder selection. Multiple folders selection has no context menu available.
