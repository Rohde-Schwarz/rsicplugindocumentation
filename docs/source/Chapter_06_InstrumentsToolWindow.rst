...
2. **Connect/Disconnect Button** - toggle button for connecting and disconnecting to the instrument. When connected, multiple functions of the ITW become available.
...
7. **Communication Action Selector** - select the type of write/query action - standard, with OPC, query binary data.
